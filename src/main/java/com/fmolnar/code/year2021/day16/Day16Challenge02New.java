...
public class Day16Challenge02New {
    ...
    private int treatAllHexa(String allLineHexa, int beginIndex, int maxLength, boolean oneliteralValue, int initiali) {
        ...
        for (int i = beginIndex; ; ) {
            ...
            Packet packet = new Packet(packetVersion,typeID);
            System.out.println("Version number: " + packetVersion + " typeID: " + typeID);
            ...
            if (typeID == 4) {
                ...
                for (; ; ) {
                    ...
                    if (subPacket.startsWith("0")) {
                        System.out.println("i: " + (i + initiali) + " Literal Value: " + new BigInteger(allSubPacketValue, 2).longValue());
                        isOnePackage = true;
                        packet.setLiteralValue(new BigInteger(allSubPacketValue, 2).longValue());
                        i = i + 5;
                        break;
                    }
                    i = i + 5;
